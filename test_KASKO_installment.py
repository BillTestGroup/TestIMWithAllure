...
def test_IM_KASKO(br):
    ...
    HB.check_cart(br)
    HB.cut_pop_up(br)
    external_id, device_price, phone_monthly_payment, phone_full_price, kasko_monthly_payment, kasko_full_price = HB.buy_device_with_kasko_installment(br, test_dude)
    HB.wait_for_order_in_work(br)
    time.sleep(20)
    HB.log_in_wso(br, wso, vix_creds)
    HB.check_wso_kasko_installment(br, test_dude, external_id, device_price, phone_monthly_payment, phone_full_price, kasko_monthly_payment, kasko_full_price)